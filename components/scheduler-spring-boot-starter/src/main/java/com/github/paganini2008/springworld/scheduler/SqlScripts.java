...
public abstract class SqlScripts {
	...
	public static final String DEF_DDL_JOB_DETAIL = "create table cluster_job_detail(job_id int primary key auto_increment, signature varchar(255), job_name varchar(255) not null, job_class_name varchar(255) not null, group_name varchar(45) not null, description varchar(255), attachment varchar(255), email varchar(45), retries int, create_date timestamp)";
	...
	public static final String DEF_INSERT_JOB_DETAIL = "insert into cluster_job_detail(signature,job_name,job_class_name,group_name,description,attachment,email,retries,create_date) values (?,?,?,?,?,?,?,?,?)";
