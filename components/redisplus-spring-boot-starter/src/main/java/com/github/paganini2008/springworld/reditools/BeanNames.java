...
public abstract class BeanNames {
	...
	public static final String REDIS_SERIALIZER = "redisplus:redis-serializer";
	...
	public static final String PUBSUB_REDIS_MESSAGE_DISPATCHER = "redisplus:pubsub-redis-message-dispatcher";
	public static final String QUEUE_REDIS_MESSAGE_DISPATCHER = "redisplus:queue-redis-message-dispatcher";
