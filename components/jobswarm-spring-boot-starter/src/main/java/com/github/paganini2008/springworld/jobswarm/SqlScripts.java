...
public abstract class SqlScripts {
	...
	public static final String DEF_INSERT_JOB_DETAIL = "insert into js_job_detail(cluster_name,group_name,job_name,job_class_name,description,attachment,email,retries,weight,create_date) values (?,?,?,?,?,?,?,?,?,?)";
	...
	public static final String DEF_UPDATE_JOB_DETAIL = "update js_job_detail set description=?, attachment=?, email=?, retries=?, weight=? where cluster_name=? and group_name=? and job_name=? and job_class_name=?";
	...
	public static final String DEF_UPDATE_JOB_RUNNING_BEGIN = "update js_job_runtime set job_state=?, last_execution_time=?, next_execution_time=? where job_id=(select job_id from js_job_detail where group_name=? and job_name=? and job_class_name=?)";
	public static final String DEF_UPDATE_JOB_RUNNING_END = "update js_job_runtime set job_state=?, last_running_state=?, last_completion_time=? where job_id=(select job_id from js_job_detail where group_name=? and job_name=? and job_class_name=?)";
