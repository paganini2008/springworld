...
public class SpringDaoProxyBean<T> extends EnhancedJdbcDaoSupport implements InvocationHandler {

	private final Class<T> interfaceClass;
	protected final Logger log;

	public SpringDaoProxyBean(Class<T> interfaceClass, DataSource dataSource) {
