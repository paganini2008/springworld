...
public abstract class SqlScripts {
	...
	public static final String DEF_DDL_JOB_TRACE = "create table crontab_job_trace(trace_id bigint primary key, job_id int not null, running_state int, address varchar(45), instance_id varchar(45), complete int, failed int, skipped int, terminated int, retries int, execution_time timestamp, completion_time timestamp)";
	public static final String DEF_DDL_JOB_EXCEPTION = "create table crontab_job_exception(trace_id bigint not null, job_id int not null, exception_content varchar(600))";
	public static final String DEF_DDL_JOB_LOG = "create table crontab_job_log(trace_id bigint not null, job_id int not null, level varchar(45), log varchar(600), create_date timestamp)";
	...
	public static final String DEF_INSERT_JOB_TRACE = "insert into crontab_job_trace(trace_id, job_id, running_state, address, instance_id, complete, failed, skipped, terminated, retries, execution_time, completion_time) values (?,?,?,?,?,?,?,?,?,?,?,?)";
	...
	public static final String DEF_INSERT_JOB_LOG = "insert into crontab_job_log(trace_id, job_id, level, log, create_date) values (?,?,?,?,?)";
