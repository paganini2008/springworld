			...
			<div id="right">
				<div id="job-detail">
					...
					<p class="detail-item">
						...
						<span id="trigger-type"></span>
						<label>Trigger Description:</label>
						<span id="trigger-description"></span>
						<label>Start Date:</label>
						<span id="trigger-start-date"></span>
						<label>End Date:</label>
						<span id="trigger-end-date"></span>
					</p>
					<p class="detail-item">
						<label>Job State:</label>
						<span id="job-state"></span>
						<label>Last Running State:</label>
						<span id="last-running-state"></span>
						<label>Last Execution Time:</label>
						<span id="last-execution-time"></span>
						<label>Last Completion Time:</label>
						<span id="last-completion-time"></span>
					</p>
				</div>
